...
module.exports = async function handler(req, res) {
  ...
  const structured = {
    ...
    hiringOrganization: { '@type': 'Organization', name: 'Space', sameAs: origin, logo: `${origin}/brand%20kit/Space%20Logo-20-transparent.png` },

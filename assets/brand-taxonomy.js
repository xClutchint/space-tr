(()=>{
  ...
  const logoNumbers={
    ...
    'Gucci':9,'Lancome':10,'Prada':11,'Valentino':12,'Burberry':13,
    'Marc Jacobs':14,'Chloe':15,'Ralph Lauren':16,'Boss':17,
  ...
  window.SPACE_BRAND_TAXONOMY={
    niche,premium,mass,ordered,retired,logos,normalize,canonicalize,categoryOf,isRetired
  };
})();

...
const localeCopy={
  en:{
    ...
    expertiseMarketLong:'Optical clocking brings each market into focus, guiding positioning, pricing and a precise route to entry.',
    expertiseSalesLong:'Selective retail networks take each brand from order to shelf through tailored execution across domestic, duty-free and e-commerce channels.',
    expertiseStewardshipLong:'Brand image, standards and long-term value are protected market by market.',
    expertiseMarketingLong:'Launches and activations give material form to brand vision across the local retail landscape.',
    expertiseOperationsLong:'Demand planning, inventory, warehousing, fulfilment and cross-border logistics are carefully coordinated as one streamlined process for the brand.',
    expertiseTraining:'Retail excellence & training',
    expertiseTrainingLong:'Beauty-advisor training ensures each product is understood, presented and represented to the standard its brand demands.',
    ...
    filmHeadline:'Global Brands,<br>Local Reach',expertiseSwipe:'Swipe to explore',teamHeadline:'The team',teamLeadership:'Leadership Team',teamSwipe:'Swipe or use the arrows to meet the team',campaignSwipe:'Swipe through campaign stories',viewProfile:'View profile',
  ...
  fr:{
    ...
    expertiseMarketLong:'L\u2019optical clocking met chaque march\u00e9 au point et guide le positionnement, la tarification et une voie d\u2019entr\u00e9e pr\u00e9cise.',
    expertiseSalesLong:'Des r\u00e9seaux retail s\u00e9lectifs accompagnent chaque marque de la commande au rayon gr\u00e2ce \u00e0 une ex\u00e9cution sur mesure dans les circuits domestiques, duty free et e-commerce.',
    ...
    expertiseMarketingLong:'Les lancements et activations donnent une forme tangible \u00e0 la vision de la marque dans le paysage retail local.',
    expertiseOperationsLong:'La planification de la demande, les stocks, l\u2019entreposage, l\u2019ex\u00e9cution des commandes et la logistique transfrontali\u00e8re sont soigneusement coordonn\u00e9s au sein d\u2019un processus fluide pour la marque.',
    expertiseTraining:'Excellence retail & formation',
    expertiseTrainingLong:'La formation des conseillers beaut\u00e9 garantit que chaque produit est compris, pr\u00e9sent\u00e9 et repr\u00e9sent\u00e9 selon les exigences de sa marque.',
    ...
    filmHeadline:'Marques internationales,<br>Portée locale',expertiseSwipe:'Balayez pour explorer',teamHeadline:'L’équipe',teamLeadership:'Équipe de direction',teamSwipe:'Balayez ou utilisez les flèches pour découvrir l’équipe',campaignSwipe:'Balayez pour découvrir les campagnes',viewProfile:'Voir le profil',

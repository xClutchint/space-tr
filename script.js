...
if(teamCarousel){
  const people=[
    ...
    {name:'K. J. Thomas',role:'Strategic Business Operations, Procurement and Supply Chain Management',image:'brand%20kit/team/KJ%20Thomas.jpg',profileRatio:.712,profilePosition:'center center',summary:'More than 15 years of experience across fragrance, beauty and travel retail, with responsibility for operations, procurement and supply chain at Space.',bio:[
    ...
    {name:'Sundeep Sharma',role:'Co-Founder and Director',image:'brand%20kit/team/Sundeep%20Sharma.jpg',profileRatio:.75,profilePosition:'center center',summary:'Co-Founder and Director of Maven Global Ltd., with extensive experience in African markets and travel retail.',bio:[
    ...
    {name:'Chandni Rana',role:'Commercial Head',image:'brand%20kit/team/Chandni%20Rana.jpg',profileRatio:.75,profilePosition:'center center',summary:'More than a decade of experience building luxury fragrance, skincare and cosmetics businesses across India and Africa.',bio:[
    ...
    {name:'Krishnamachari Rangarajan',role:'Finance, Treasury Management, HR and Administration',image:'brand%20kit/team/Krishnamachari%20Rangarajan.jpg',profileRatio:.8,profilePosition:'center center',summary:'Nearly four decades of experience in accounting, finance and factory commercial operations within the FMCG industry.',bio:[
    ...
    {name:'Baptiste Vesin',role:'Business Development Director',image:'brand%20kit/team/Baptiste%20VESIN.png',profileRatio:.792,profilePosition:'center center',summary:'More than 20 years of experience developing distributor and retailer relationships across African local and travel retail markets.',bio:[
  ...
  const renderProfile=index=>{const person=personForLanguage(index);profileOverlay.dataset.profile=String(index);profileOverlay.style.setProperty('--profile-width',person.profileRatio?`${person.profileRatio*100}dvh`:'64vw');profileOverlay.style.setProperty('--profile-position',person.profilePosition||'center 15%');profileImage.src=person.image;profileImage.alt=person.name;profileLabel.textContent=localeCopy[currentLanguage].profileLabel;profileName.textContent=person.name;profileRole.textContent=person.role;profileBio.innerHTML=person.bio.map(paragraph=>`<p>${paragraph}</p>`).join('')};
